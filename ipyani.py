...
def animate(fname,  index=1, symbol='r', logx=True, logy=False, max_index=-1, ymin=None, ymax=None, times=None, interval=50):
    ...
    #Exporting animation
    sol_ani=animation.FuncAnimation(fig,update_img,len(saved[:max_index,:,index])/interval,interval=interval, blit=True)
    return sol_ani
