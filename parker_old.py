...
def deriv_test(rad, log=True):
    return [np.log(2*floor), np.log(rad), 1.]    
...
grid=hydro.Grid(rmin, rmax, parker, M=M_sun, n=100, safety=0.6, Re=150., params=d, symbol='rs',  floor=floor, logr=True)
