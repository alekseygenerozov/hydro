...
grid=hydro.Grid(rmin, rmax, background, M=M_sun, n=100, safety=0.6, Re=100, params=d, floor=floor, symbol='r', logr=False, q=delta_src)
grid.evolve(5*tcross,analytic_func=[None, None, None, None, None, None])
