...
grid=hydro.Grid(rmin, rmax, parker, M=M_sun, n=200, safety=0.6, Re=200., params=d, symbol='r', logr=True)
grid.evolve(3.*tcross,analytic_func=[None, None, None, None, None, None], max_steps=10)
